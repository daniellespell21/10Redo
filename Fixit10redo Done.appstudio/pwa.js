...
const cacheName = 'Fixit10redo_-2020-11-25 12:51:47.546761'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit10redo_'.length) === 'Fixit10redo_') {
